   ...
   <li class="no-padding">
                     ...
                     <li class="no-padding"><a class="waves-effect waves-grey" href="UpdateCalendar.php"><i class="material-icons">date_range</i>Update Calendar</a></li>

                     <li class="no-padding"><a class="waves-effect waves-grey" href="project-details.php"><i class="material-icons">import_contacts</i>Project Details</a></li>
