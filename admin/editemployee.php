...
$sql="UPDATE personal_details SET firstname=:fname,lastname=:lname,gender=:gender,Department=:department,nationality=:country WHERE personal_details.empid=:eid";
...
$email=$_POST['email'];
$sql="UPDATE contact_details SET address1=:address,emailid=:email,mobilenumber=:mobileno,city=:city WHERE contact_details.empid=:eid";
$query = $dbh->prepare($sql);
...
$sql = "SELECT * from contact_details join personal_details on contact_details.empid=personal_details.empid where personal_details.empid=:eid";
...
<label for="empcode">BMS ID</label>
...
<input id="phone" name="mobileno" type="tel" value="<?php echo htmlentities($result->mobilenumber);?>" maxlength="10" autocomplete="off" required>
 </div>
...
<input id="address" name="address" type="text"  value="<?php echo htmlentities($result->address1);?>" autocomplete="off" required>
</div>
...
<input id="country" name="country" type="text"  value="<?php echo htmlentities($result->nationality);?>" autocomplete="off" required>
</div>
