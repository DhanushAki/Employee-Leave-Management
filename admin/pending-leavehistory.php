...
<?php 
$status=0;
$sql = "SELECT * from leaveform join personal_details on leaveform.ID=personal_details.empid where leaveform.status=:status";
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td> <b><?php echo htmlentities($cnt);?></b></td>
                                              <td><a href="editemployee.php?empid=<?php echo htmlentities($result->empid);?>" target="_blank"><?php echo htmlentities($result->firstname." ".$result->lastname);?>(<?php echo htmlentities($result->empid);?>)</a></td>
